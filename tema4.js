...
// File content
for (fisier = 1; fisier <= 5; fisier++) {
  let file_content = fs.readFileSync(`m_rar_2018_${fisier}.txt`, 'utf8');
  ...
  if (!sw) {
    ...
    } while (!equal(previous, calculatedX) && iterations < 10000);
